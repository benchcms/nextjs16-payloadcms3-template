...
export async function seedPress(payload: Payload) {
    ...
    for (let i = 0; i < 10; i++) {
        await payload.create({
            ...
            data: {
                ...
                journal: faker.helpers.maybe(() => faker.company.name() + " " + faker.helpers.arrayElement(["News", "Times", "Journal", "Post"])),
                excerpt: faker.helpers.maybe(() => createRichText(faker.lorem.paragraph())),

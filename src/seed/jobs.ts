    ...
    for (let i = 0; i < 8; i++) {
        await payload.create({
            ...
            data: {
                ...
                description: createRichTextParagraphs([faker.lorem.paragraph(), faker.lorem.paragraph(), faker.lorem.paragraph()]),
                requirements: createRichTextParagraphs([faker.lorem.sentence(), faker.lorem.sentence(), faker.lorem.sentence()]),
